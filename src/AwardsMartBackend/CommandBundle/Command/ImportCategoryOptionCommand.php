...
class ImportCategoryOptionCommand extends ContainerAwareCommand
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $this
            ->setName('aw:import_category_options')
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $query = "SELECT * FROM awards_categorycolorlinking";
        ...
        foreach($results->fetchAll(PDO::FETCH_OBJ) as $option){
            $new_pdo->insert("category_product_option",array(
