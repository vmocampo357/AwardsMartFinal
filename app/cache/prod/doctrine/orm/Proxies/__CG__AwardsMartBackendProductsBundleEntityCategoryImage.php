 ...
 */
class CategoryImage extends \AwardsMartBackend\ProductsBundle\Entity\CategoryImage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AwardsMartBackend\\ProductsBundle\\Entity\\CategoryImage' . "\0" . 'id', '' . "\0" . 'AwardsMartBackend\\ProductsBundle\\Entity\\CategoryImage' . "\0" . 'source', '' . "\0" . 'AwardsMartBackend\\ProductsBundle\\Entity\\CategoryImage' . "\0" . 'role', '' . "\0" . 'AwardsMartBackend\\ProductsBundle\\Entity\\CategoryImage' . "\0" . 'sortOrder', '' . "\0" . 'AwardsMartBackend\\ProductsBundle\\Entity\\CategoryImage' . "\0" . 'dateAdded', '' . "\0" . 'AwardsMartBackend\\ProductsBundle\\Entity\\CategoryImage' . "\0" . 'category'];
        }
     ...
     * {@inheritDoc}
     */
    public function setCategory(\AwardsMartBackend\ProductsBundle\Entity\Category $category)
    {
