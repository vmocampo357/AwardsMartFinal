 ...
 */
class ProductImage extends \AwardsMartBackend\ProductsBundle\Entity\ProductImage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AwardsMartBackend\\ProductsBundle\\Entity\\ProductImage' . "\0" . 'id', '' . "\0" . 'AwardsMartBackend\\ProductsBundle\\Entity\\ProductImage' . "\0" . 'source', '' . "\0" . 'AwardsMartBackend\\ProductsBundle\\Entity\\ProductImage' . "\0" . 'role', '' . "\0" . 'AwardsMartBackend\\ProductsBundle\\Entity\\ProductImage' . "\0" . 'sortOrder', '' . "\0" . 'AwardsMartBackend\\ProductsBundle\\Entity\\ProductImage' . "\0" . 'dateAdded', '' . "\0" . 'AwardsMartBackend\\ProductsBundle\\Entity\\ProductImage' . "\0" . 'product'];
        }
     ...
     * {@inheritDoc}
     */
    public function setProduct(\AwardsMartBackend\ProductsBundle\Entity\Product $product)
    {
