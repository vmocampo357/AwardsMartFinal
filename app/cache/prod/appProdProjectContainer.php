...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.cart_mailer' => 'getApp_CartMailerService',
            'app.cart_provider' => 'getApp_CartProviderService',
            'app.cart_uploader' => 'getApp_CartUploaderService',
            ...
            'security.user.provider.concrete.awardsmart_db_provider' => 'getSecurity_User_Provider_Concrete_AwardsmartDbProviderService',
    ...
    /*
     * Gets the 'app.cart_mailer' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AwardsMartBackend\CustomerBundle\Services\CartMailerService A AwardsMartBackend\CustomerBundle\Services\CartMailerService instance
     */
    protected function getApp_CartMailerService()
    {
        return $this->services['app.cart_mailer'] = new \AwardsMartBackend\CustomerBundle\Services\CartMailerService($this->get('swiftmailer.mailer.default'), $this->get('twig'));
    }

    /*
     * Gets the 'app.cart_provider' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AwardsMartBackend\CustomerBundle\Services\CartServiceProvider A AwardsMartBackend\CustomerBundle\Services\CartServiceProvider instance
     */
    protected function getApp_CartProviderService()
    {
        return $this->services['app.cart_provider'] = new \AwardsMartBackend\CustomerBundle\Services\CartServiceProvider($this->get('session'), $this->get('doctrine.orm.default_entity_manager'));
    }

    /*
     * Gets the 'app.cart_uploader' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AwardsMartBackend\CustomerBundle\Services\CartUploaderService A AwardsMartBackend\CustomerBundle\Services\CartUploaderService instance
     */
    protected function getApp_CartUploaderService()
    {
        return $this->services['app.cart_uploader'] = new \AwardsMartBackend\CustomerBundle\Services\CartUploaderService(($this->targetDirs[2].'/../public_html/bundles/assets/uploads/new'), '/bundles/assets/uploads/new', $this->get('request_stack'));
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('Fi0Cy9T0Gr', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('7SneAm1bKG', 0, 'yiFKjwMEGoVjM-X3grqrHQ', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'awardsmart_symfony', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\AwardsMartBackend\\ProductsBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\AwardsMartBackend\\CustomerBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\AwardsMartFrontend\\PrimarySiteBundle\\Entity'), 3 => ($this->targetDirs[3].'\\src\\AwardsMartBackend\\AdminInterfaceBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'AwardsMartBackend\\ProductsBundle\\Entity');
        $c->addDriver($b, 'AwardsMartBackend\\CustomerBundle\\Entity');
        $c->addDriver($b, 'AwardsMartFrontend\\PrimarySiteBundle\\Entity');
        $c->addDriver($b, 'AwardsMartBackend\\AdminInterfaceBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('ProductsBundle' => 'AwardsMartBackend\\ProductsBundle\\Entity', 'CustomerBundle' => 'AwardsMartBackend\\CustomerBundle\\Entity', 'PrimarySiteBundle' => 'AwardsMartFrontend\\PrimarySiteBundle\\Entity', 'AdminInterfaceBundle' => 'AwardsMartBackend\\AdminInterfaceBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_0458b23342956efc9601a78c97d1cb5608be0c7b828f3fd7d944b0858183345b');
    ...
    {
        return $this->services['property_accessor'] = new \Symfony\Component\PropertyAccess\PropertyAccessor(false, false, \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('YT3GUjov2T', NULL, 'yiFKjwMEGoVjM-X3grqrHQ', $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('AwardsMartBackend\\AdminInterfaceBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\BCryptPasswordEncoder', 'arguments' => array(0 => 13))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $h = new \Symfony\Component\HttpFoundation\RequestMatcher('^/administrator');
        ...
        $l->setOptions(array('login_path' => 'admin.login', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($i, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => new \Symfony\Component\Security\Core\User\InMemoryUserProvider(), 1 => ${($_ = isset($this->services['security.user.provider.concrete.awardsmart_db_provider']) ? $this->services['security.user.provider.concrete.awardsmart_db_provider'] : $this->getSecurity_User_Provider_Concrete_AwardsmartDbProviderService()) && false ?: '_'}), 'main', $a, $c, $d), 2 => $k, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $g, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $j, 'main', $l, $m, array('check_path' => 'admin.login', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '58bae7ddb85912.09266971', $a, $g), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, ${($_ = isset($this->services['security.access.decision_manager']) ? $this->services['security.access.decision_manager'] : $this->getSecurity_Access_DecisionManagerService()) && false ?: '_'}, $i, $g)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $d, $j, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $j, 'admin.login', false), NULL, NULL, $a, false), new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('main', 'security.user_checker', NULL, true, false, 'security.user.provider.concrete.in_memory', 'main', 'security.authentication.form_entry_point.main', NULL, NULL, array(0 => 'logout', 1 => 'form_login', 2 => 'anonymous')));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('awardsmailer@gmail.com');
        $a->setPassword('456654aaa');
        $a->setAuthMode('login');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\AwardsMartFrontend\\CoreBundle/Resources/views'), 'Core');
        $instance->addPath(($this->targetDirs[3].'\\src\\AwardsMartFrontend\\PrimarySiteBundle/Resources/views'), 'PrimarySite');
        $instance->addPath(($this->targetDirs[3].'\\src\\AwardsMartBackend\\AdminInterfaceBundle/Resources/views'), 'AdminInterface');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('cb25b2f718ab3ba314c19aa7a0da628140a3630f');
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Pnv0aqaOLa', 0, 'yiFKjwMEGoVjM-X3grqrHQ', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('056RZx-dqd', 0, 'yiFKjwMEGoVjM-X3grqrHQ', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider(${($_ = isset($this->services['security.user.provider.concrete.awardsmart_db_provider']) ? $this->services['security.user.provider.concrete.awardsmart_db_provider'] : $this->getSecurity_User_Provider_Concrete_AwardsmartDbProviderService()) && false ?: '_'}, new \Symfony\Component\Security\Core\User\UserChecker(), 'main', $this->get('security.encoder_factory'), true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('58bae7ddb85912.09266971')), true);
    ...
    /*
     * Gets the 'security.user.provider.concrete.awardsmart_db_provider' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSecurity_User_Provider_Concrete_AwardsmartDbProviderService()
    {
        return $this->services['security.user.provider.concrete.awardsmart_db_provider'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'AdminInterfaceBundle:User', 'username', NULL);
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'CommandBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\AwardsMartBackend\\CommandBundle'),
                    'namespace' => 'AwardsMartBackend\\CommandBundle',
                ),
                'ProductsBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\AwardsMartBackend\\ProductsBundle'),
                    'namespace' => 'AwardsMartBackend\\ProductsBundle',
                ),
                'CustomerBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\AwardsMartBackend\\CustomerBundle'),
                    'namespace' => 'AwardsMartBackend\\CustomerBundle',
                ),
                'FrontProviderBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\AwardsMartBackend\\FrontProviderBundle'),
                    'namespace' => 'AwardsMartBackend\\FrontProviderBundle',
                ),
                'CoreBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\AwardsMartFrontend\\CoreBundle'),
                    'namespace' => 'AwardsMartFrontend\\CoreBundle',
                ),
                'PrimarySiteBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\AwardsMartFrontend\\PrimarySiteBundle'),
                    'namespace' => 'AwardsMartFrontend\\PrimarySiteBundle',
                ),
                'AdminInterfaceBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\AwardsMartBackend\\AdminInterfaceBundle'),
                    'namespace' => 'AwardsMartBackend\\AdminInterfaceBundle',
                ),
            ); break;
            case 'uploads_dir': $value = ($this->targetDirs[2].'/../public_html/bundles/assets/uploads/new'); break;
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'CommandBundle' => 'AwardsMartBackend\\CommandBundle\\CommandBundle',
                'ProductsBundle' => 'AwardsMartBackend\\ProductsBundle\\ProductsBundle',
                'CustomerBundle' => 'AwardsMartBackend\\CustomerBundle\\CustomerBundle',
                'FrontProviderBundle' => 'AwardsMartBackend\\FrontProviderBundle\\FrontProviderBundle',
                'CoreBundle' => 'AwardsMartFrontend\\CoreBundle\\CoreBundle',
                'PrimarySiteBundle' => 'AwardsMartFrontend\\PrimarySiteBundle\\PrimarySiteBundle',
                'AdminInterfaceBundle' => 'AwardsMartBackend\\AdminInterfaceBundle\\AdminInterfaceBundle',
            ),
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'appProdProjectContainer',
            'database_host' => '127.0.0.1',
            'database_port' => NULL,
            'database_name' => 'awardsmart_symfony',
            'database_user' => 'root',
            'database_password' => NULL,
            'mailer_transport' => 'smtp',
            'mailer_host' => 'smtp.gmail.com',
            'mailer_user' => 'awardsmailer@gmail.com',
            'mailer_password' => '456654aaa',
            'secret' => 'cb25b2f718ab3ba314c19aa7a0da628140a3630f',
            'uploads_web_path' => '/bundles/assets/uploads/new',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'cb25b2f718ab3ba314c19aa7a0da628140a3630f',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'awardsmailer@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => '456654aaa',
